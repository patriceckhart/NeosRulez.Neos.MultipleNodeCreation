...
/***/ "./src/components/MultipleSiteNodeCreation.js":
/*!****************************************************!*\
  !*** ./src/components/MultipleSiteNodeCreation.js ***!
  \****************************************************/
/*! no static exports found */
...
var _MultipleSiteNodeCreationDialog = __webpack_require__(/*! ./MultipleSiteNodeCreationDialog */ "./src/components/MultipleSiteNodeCreationDialog.js");

var _MultipleSiteNodeCreationDialog2 = _interopRequireDefault(_MultipleSiteNodeCreationDialog);
...
var MultipleSiteNodeCreation = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
        i18nRegistry: globalRegistry.get('i18n')
    };
}), _dec(_class = function (_React$Component) {
    _inherits(MultipleSiteNodeCreation, _React$Component);

    function MultipleSiteNodeCreation(props) {
        _classCallCheck(this, MultipleSiteNodeCreation);

        var _this = _possibleConstructorReturn(this, (MultipleSiteNodeCreation.__proto__ || Object.getPrototypeOf(MultipleSiteNodeCreation)).call(this, props));
    ...
    _createClass(MultipleSiteNodeCreation, [{
        key: "toggleDialog",
        ...
        value: function render() {
            ...
            var minimumRows = this.props.configuration.minimumRows;


            return _react2.default.createElement(
                "div",
                { className: _styles2.default.createMultipleSiteNodeWrapper },
                _react2.default.createElement(
                    _reactUiComponents.Button,
                    { style: "clean", onClick: function onClick() {
                            return _this2.toggleDialog();
                        } },
                    _react2.default.createElement(_reactUiComponents.Icon, { icon: "fas fa-plus", style: { marginRight: '0.5em' } }),
                    " ",
                    _react2.default.createElement(
                        "span",
                        null,
                        this.props.i18nRegistry.translate(unescape('NeosRulez.Neos.MultipleNodeCreation:Main:content.header'))
                    )
                ),
                this.state.showDialog && _react2.default.createElement(_MultipleSiteNodeCreationDialog2.default, { toggleDialog: function toggleDialog() {
                        return _this2.toggleDialog();
    ...
    return MultipleSiteNodeCreation;
}(_react2.default.Component)) || _class);
exports.default = MultipleSiteNodeCreation;

/***/ }),

/***/ "./src/components/MultipleSiteNodeCreationDialog.js":
/*!**********************************************************!*\
  !*** ./src/components/MultipleSiteNodeCreationDialog.js ***!
  \**********************************************************/
/*! no static exports found */
...
var _MultipleSiteNodeCreationRow = __webpack_require__(/*! ./MultipleSiteNodeCreationRow */ "./src/components/MultipleSiteNodeCreationRow.js");

var _MultipleSiteNodeCreationRow2 = _interopRequireDefault(_MultipleSiteNodeCreationRow);
...
var MultipleSiteNodeCreationDialog = (_dec = (0, _reactRedux.connect)((0, _plowJs.$transform)({
    ...
    _inherits(MultipleSiteNodeCreationDialog, _React$Component);

    function MultipleSiteNodeCreationDialog(props) {
        _classCallCheck(this, MultipleSiteNodeCreationDialog);

        var _this = _possibleConstructorReturn(this, (MultipleSiteNodeCreationDialog.__proto__ || Object.getPrototypeOf(MultipleSiteNodeCreationDialog)).call(this, props));
        ...
        _this.addLines = _this.addLines.bind(_this);
        _this.fetchNodeTypes = _this.fetchNodeTypes.bind(_this);
        _this.createNodes = _this.createNodes.bind(_this);
        _this.setNode = _this.setNode.bind(_this);
        _this.hidePages = _this.hidePages.bind(_this);
        _this.hidePagesInMenu = _this.hidePagesInMenu.bind(_this);
        return _this;
    }

    _createClass(MultipleSiteNodeCreationDialog, [{
        key: "fetchNodeTypes",
        value: function fetchNodeTypes() {
            var _this2 = this;

            fetch('/neos/schema/node-type', { method: 'GET' }).then(function (response) {
                return response.text();
            }).then(function (result) {
                _this2.setState({ nodeTypes: result });
                _this2.addLines();
        ...
        value: function createNodes() {
            ...
            if (nodes) {
                ...
                fetch('/multiplenodecreation/create', requestOptions).then(function (response) {
                    return response.text();
                }).then(function (result) {
        ...
        value: function addLines() {
            ...
            var minRows = this.props.minimumRows;
            var items = [];
            var count = parseInt(this.state.count);
            for (var i = 0; i < minRows; i++) {
                items.push(_react2.default.createElement(_MultipleSiteNodeCreationRow2.default, { key: 'row' + i, id: count, nodeTypes: this.state.nodeTypes, i18nRegistry: this.props.i18nRegistry, setNode: function setNode(p) {
                        return _this4.setNode(p);
                    } }));
                count = count + 1;
            }
            this.setState({ count: count });
            this.setState({ rows: [].concat(_toConsumableArray(this.state.rows), [items]) });
        }
    }, {
        key: "hidePages",
        ...
        key: "hidePagesInMenu",
        value: function hidePagesInMenu() {
            this.setState(function (prevState) {
                return {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                { title: this.state.creating ? this.props.i18nRegistry.translate(unescape('NeosRulez.Neos.MultipleNodeCreation:Main:content.progressHeader')) : this.props.i18nRegistry.translate(unescape('NeosRulez.Neos.MultipleNodeCreation:Main:content.header')), isOpen: true, onRequestClose: this.props.toggleDialog, actions: [_react2.default.createElement(
                        _react.Fragment,
                        null,
                        !this.state.creating && _react2.default.createElement(
                            _react.Fragment,
                            null,
                            _react2.default.createElement(
                                _reactUiComponents.Button,
                                { type: "button", className: _styles2.default.primaryButton, onClick: function onClick() {
                                        return _this5.createNodes();
                            ...
                            _react2.default.createElement(
                                _reactUiComponents.Button,
                                { type: "button", onClick: this.props.toggleDialog },
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(_reactUiComponents.CheckBox, { id: "hidePages", isChecked: !!this.state.hidePages, onClick: function onClick() {
                                        return _this5.hidePages();
                                    } })
                            ),
                            _react2.default.createElement(
                                "div",
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "div",
                                { style: { display: 'inline-block' } },
                                _react2.default.createElement(_reactUiComponents.CheckBox, { id: "hidePagesInMenu", isChecked: !!this.state.hidePagesInMenu, onClick: function onClick() {
                                        return _this5.hidePagesInMenu();
                                    } })
                            ),
                            _react2.default.createElement(
                                "div",
    ...
    return MultipleSiteNodeCreationDialog;
}(_react2.default.Component)) || _class) || _class);
exports.default = MultipleSiteNodeCreationDialog;

/***/ }),

/***/ "./src/components/MultipleSiteNodeCreationRow.js":
/*!*******************************************************!*\
  !*** ./src/components/MultipleSiteNodeCreationRow.js ***!
  \*******************************************************/
/*! no static exports found */
...
var MultipleSiteNodeCreationRow = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
        i18nRegistry: globalRegistry.get('i18n')
    };
}), _dec(_class = function (_React$Component) {
    _inherits(MultipleSiteNodeCreationRow, _React$Component);

    function MultipleSiteNodeCreationRow(props) {
        _classCallCheck(this, MultipleSiteNodeCreationRow);

        var _this = _possibleConstructorReturn(this, (MultipleSiteNodeCreationRow.__proto__ || Object.getPrototypeOf(MultipleSiteNodeCreationRow)).call(this, props));
    ...
    _createClass(MultipleSiteNodeCreationRow, [{
        key: "onValueChange",
        value: function onValueChange(value) {
            var _this2 = this;

            this.setState({ nodeType: value }, function () {
                _this2.setNode();
            });
        }
    }, {
        ...
        value: function setNode() {
            var node = { id: this.props.id, title: this.state.title, nodeType: this.state.nodeType };
        ...
        value: function componentDidMount() {
            ...
            var nodeTypes = JSON.parse(this.props.nodeTypes).nodeTypes;
            var superTypes = JSON.parse(this.props.nodeTypes).inheritanceMap.subTypes['Neos.Neos:Document'];
            var result = [];
            for (var i in superTypes) {
                var superType = superTypes[i].replace('"', '');
                if (nodeTypes[superType] !== undefined) {
                    var label = nodeTypes[superType].ui.label;
                    var icon = nodeTypes[superType].ui.icon;
                    var item = {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactUiComponents.TextInput, { placeholder: this.props.i18nRegistry.translate(unescape('NeosRulez.Neos.MultipleNodeCreation:Main:content.title')), onChange: function onChange(p) {
                            return _this4.onTextChange(p);
                        } })
                ),
                _react2.default.createElement(
                    "div",
                    { className: _styles2.default.column },
                    _react2.default.createElement(_reactUiComponents.SelectBox, { placeholder: this.props.i18nRegistry.translate(unescape('NeosRulez.Neos.MultipleNodeCreation:Main:content.nodeType')), options: this.state.nodeTypes, value: this.state.nodeType, onValueChange: function onValueChange(p) {
                            return _this4.onValueChange(p);
                        } })
                )
            );
        }
    ...
    return MultipleSiteNodeCreationRow;
}(_react2.default.Component)) || _class);
exports.default = MultipleSiteNodeCreationRow;
...
var _MultipleSiteNodeCreation = __webpack_require__(/*! ./components/MultipleSiteNodeCreation */ "./src/components/MultipleSiteNodeCreation.js");

var _MultipleSiteNodeCreation2 = _interopRequireDefault(_MultipleSiteNodeCreation);
...
(0, _neosUiExtensibility2.default)('NeosRulez.Neos.MultipleNodeCreation', {}, function (globalRegistry, _ref) {
    var frontendConfiguration = _ref.frontendConfiguration;

    var containerRegistry = globalRegistry.get('containers');
    var originalPageTreeSearchbar = containerRegistry.get('LeftSideBar/Top/PageTreeSearchbar');
    var configuration = {
...
var extendedPageTreeSearchbar = function extendedPageTreeSearchbar(OriginalPageTreeSearchbar, configuration) {
    return function (_PureComponent) {
        _inherits(pageTreeSearchbar, _PureComponent);

        function pageTreeSearchbar() {
            _classCallCheck(this, pageTreeSearchbar);

            return _possibleConstructorReturn(this, (pageTreeSearchbar.__proto__ || Object.getPrototypeOf(pageTreeSearchbar)).apply(this, arguments));
        }

        _createClass(pageTreeSearchbar, [{
            key: 'render',
            value: function render() {
                return _react2.default.createElement(
                    _react.Fragment,
                    null,
                    _react2.default.createElement(OriginalPageTreeSearchbar, null),
                    _react2.default.createElement(_MultipleSiteNodeCreation2.default, { configuration: configuration })
                );
            }
        }]);

        return pageTreeSearchbar;
...
module.exports = {"createMultipleSiteNodeWrapper":"styles__createMultipleSiteNodeWrapper___1L8fy","row":"styles__row___2gmnz","column":"styles__column___2r45X","primaryButton":"styles__primaryButton___rDWiu"};
